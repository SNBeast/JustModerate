...
public class Main {
    ...
    private static ArrayList<String> hostAuthorizedUsers;
    ...
    public static void main(final String[] args) {
        ...
        if (args.length > 1) {
            ...
            hostAuthorizedUsers = (ArrayList<String>)List.of(Arrays.copyOfRange(args, hostAuthorizedStart, args.length));
        }
        else {
